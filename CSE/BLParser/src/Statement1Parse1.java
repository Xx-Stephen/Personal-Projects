...
public final class Statement1Parse1 extends Statement1 {
    ...
    private static void parseIf(Queue<String> tokens, Statement s) {
        ...
        Reporter.assertElseFatalError(Tokenizer.isCondition(condition),
                "Violation of: Valid condition");
        Condition c = parseCondition(condition);
        String then = tokens.dequeue();
        Reporter.assertElseFatalError(then.equals("THEN"),
                "Violation of: Syntax error, Expecting THEN");
        Statement content = s.newInstance();
        content.parseBlock(tokens);
        String nextTerm = tokens.dequeue();
        Reporter.assertElseFatalError(
                nextTerm.equals("ELSE") || nextTerm.equals("END"),
                "Violation of: Syntax error, Expecting ELSE or END");
        if (nextTerm.equals("END")) {
            String iF = tokens.dequeue();
            Reporter.assertElseFatalError(iF.equals("IF"),
                    "Violation of: Syntax error, Expecting IF");
            s.assembleIf(c, content);
        } else if (nextTerm.equals("ELSE")) {
            Statement elseContent = s.newInstance();
            elseContent.parseBlock(tokens);
            ...
            Reporter.assertElseFatalError(iF.equals("IF"),
                    "Violation of: Syntax error, Expecting IF");
            s.assembleIfElse(c, content, elseContent);
        }
    ...
    private static void parseWhile(Queue<String> tokens, Statement s) {
        ...
        Reporter.assertElseFatalError(dO.equals("DO"),
                "Violation of: Syntax error, Expecting DO");
        Statement content = s.newInstance();
        content.parseBlock(tokens);
        String end = tokens.dequeue();
        Reporter.assertElseFatalError(end.equals("END"),
        ...
        Reporter.assertElseFatalError(whilE.equals("WHILE"),
                "Violation of: Syntax error, Expecting WHILE");
        s.assembleWhile(c, content);
