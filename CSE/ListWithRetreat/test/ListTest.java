...
public abstract class ListTest {
    ...
    @Test
    public final void testRetreatOneOnLink() {
    ...
    @Test
    public final void testRetreatOneOnNoreEmptyLink() {
        List<String> list1 = this.createFromArgsTest(1, "red", "black");
        List<String> list2 = this.createFromArgsRef(0, "red", "black");
        list1.retreat();
        assertEquals(list1, list2);
    }

    @Test
    public final void testRetreatOneOnMoreRightLink() {
        List<String> list1 = this.createFromArgsTest(3, "red", "black",
                "green");
        List<String> list2 = this.createFromArgsRef(2, "red", "black", "green");
        list1.retreat();
        assertEquals(list1, list2);
    }

    @Test
    public final void testRetreatMoreOnLink() {
        List<String> list1 = this.createFromArgsTest(3, "red", "black",
                "green");
        List<String> list2 = this.createFromArgsRef(0, "red", "black", "green");
        list1.retreat();
        list1.retreat();
        list1.retreat();
        assertEquals(list1, list2);
