...
public class Map4<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        int hashRes = key.hashCode();
        int modRes = mod(hashRes, this.hashTable.length);
        this.hashTable[modRes].add(key, value);
        this.size += 1;
    }
    ...
    public final Pair<K, V> remove(K key) {
        ...
        int modRes = mod(hashRes, this.hashTable.length);
        Pair<K, V> res;
        res = this.hashTable[modRes].remove(key);
        this.size -= 1;
        return res;
    }
    ...
    public final Pair<K, V> removeAny() {
        ...
        res = this.hashTable[i].removeAny();
        this.size -= 1;
        return res;
    }
    ...
    public final V value(K key) {
        ...
        int hashRes = key.hashCode();
        int modRes = mod(hashRes, this.hashTable.length);
        res = this.hashTable[modRes].value(key);
        return res;
    }
    ...
    public final boolean hasKey(K key) {
        ...
        int hashRes = key.hashCode();
        int modRes = mod(hashRes, this.hashTable.length);
        res = this.hashTable[modRes].hasKey(key);
